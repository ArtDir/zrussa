...
class ShopCards {
  ...
  createProductCardHTML(product) {
    const tagHTML = product.tag ? 
      `<span class="product-tag ${this.getTagClass(product.tag)}">${this.getTagText(product.tag)}</span>` : '';
  ...
  renderCards(products) {
    ...
    if (this.productsContainer && this.productsContainer.parentNode) {
      this.productsContainer.parentNode.insertBefore(newProductsContainer, this.productsContainer);
    }
  }
}
