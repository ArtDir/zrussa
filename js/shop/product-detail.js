...
class ProductDetail {
      ...
      <div class="product-detail">
        ...
        <div class="product-detail__content">
          <div class="product-detail__image-container">
            ...
            <span class="product-tag product-detail__tag"></span>
          </div>
  ...
  fillProductDetail(product) {
    ...
    overlay.querySelector('.product-detail__author').textContent = `Автор: ${product.author}`;
    overlay.querySelector('.product-detail__price').textContent = this.formatPrice(product.price);
    ...
    if (product.tag) {
      ...
      tagElement.className = `product-tag product-detail__tag ${this.getTagClass(product.tag)}`;
  ...
  updateAddButton(button, productId, quantity) {
    ...
    if (button.classList.contains('product-detail__counter')) {
      const countElement = button.querySelector('.product-detail__counter__count');
      if (countElement) {
    ...
    const decreaseButton = counterElement.querySelector('[data-action="decrease"]');
    const increaseButton = counterElement.querySelector('[data-action="increase"]');
